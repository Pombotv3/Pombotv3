...
def parse_direct_links(text_block: str, default_type: str = "photo") -> list[dict]:
    ...
    for line in text_block.splitlines():
        ...
        # Strip internal quotes or formatting noise
...
async def send_universal_media(chat_id: int, target: str, caption: str = None, reply_markup: dict = None, preferred: str = "photo"):
    ...
    it automatically falls back without crashing or hanging the bot.
    """
    target = target.strip()
    ...
    # If all fail, fall back cleanly to text
...
async def send_first_media_with_bottom_bar(chat_id: int, media_list: list, caption: str):
    ...
    # Note: Duplicate 👇 removed here to ensure clean flow with no duplicate messages
...
# Handles clicking solid-colored plan buttons (e.g. buy_79_1MonthVIP)
