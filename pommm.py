...
# ==========================================
# CRASH-PROOF BOT DISPATCHER LOGIC
# ==========================================
bot_router = Router()
...
async def send_first_media_with_bottom_bar(chat_id: int, media_list: list, caption: str):
    ...
    if len(media_list) == 1:
        ...
        # If Telegram fails to resolve the link, fall back safely
    ...
    # Multiple items: Split into valid albums of 2 to 10 items
    ...
    for chunk_idx, chunk in enumerate(chunks):
        ...
        try:
            ...
            await manager.bot.send_message(chat_id=chat_id, text=caption)

    # Attach bottom menu cleanly
    await manager.send_raw("sendMessage", {
        "chat_id": chat_id,
        "text": "👇",
        "reply_markup": BOTTOM_REPLY_KEYBOARD
...
async def send_plan_presentation(chat_id: int):
    ...
    await manager.bot.send_message(chat_id, " ══════« CHOOSE PLAN »═════")[span_0](start_span)[span_0](end_span)[span_1](start_span)[span_1](end_span)
