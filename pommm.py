...
async def init_db():
    ...
    async with AsyncSessionLocal() as session:
        ...
        if not first_media:
            default_media = [
                {"type": "photo", "url": "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800"}
            ]
        ...
        if not plan_media:
            default_plan_media = [
                {"type": "photo", "url": "https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=800"}
            ]
...
def make_7_plans_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🟢 1 Month VIP - ₹79", callback_data="buy_79_1MonthVIP")],
            [InlineKeyboardButton(text="🔴 2 Months VIP - ₹149", callback_data="buy_149_2MonthsVIP")],
            [InlineKeyboardButton(text="🔵 3 Months VIP - ₹199", callback_data="buy_199_3MonthsVIP")],
            [InlineKeyboardButton(text="🟢 6 Months VIP - ₹299", callback_data="buy_299_6MonthsVIP")],
            [InlineKeyboardButton(text="🔴 1 Year VIP - ₹399", callback_data="buy_399_1YearVIP")],
            [InlineKeyboardButton(text="🔵 Lifetime Access - ₹499", callback_data="buy_499_LifetimeVIP")],
            [InlineKeyboardButton(text="🟢 Ultra Mega VIP - ₹799", callback_data="buy_799_UltraMegaVIP")]
        ]
    )
...
async def send_plan_presentation(chat_id: int):
    ...
    if media_2:
        if len(media_2) == 1:
            ...
            await send_dynamic_media_group(bot, chat_id, media_2[:-1], "")
            last_item = media_2[-1]
