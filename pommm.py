...
# ACCEPTS BOTH NORMAL PHOTOS AND UNCOMPRESSED DOCUMENT FILES
...
async def receive_screenshot_proof(message: types.Message, state: FSMContext):
    ...
    # 1. Guaranteed User Acknowledgment
    await manager.send_raw("sendMessage", {
        "chat_id": message.chat.id,
        "text": "✅ <b>Payment screenshot received!</b>\n\nOur admins will verify your payment shortly and send your private access link right here.",
        "parse_mode": "HTML",
        "reply_markup": BOTTOM_REPLY_KEYBOARD
    })

    # 2. Guaranteed Admin Notification
    admin_ids = await get_admin_ids()
    if admin_ids and row:
        ...
        for aid in admin_ids:
            try:
                # Universal sender handles document/photo file_id automatically without crashing
                await send_universal_media(
                    chat_id=aid,
                    target=file_id,
                    caption=caption,
    ...
    <main class="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        ...
        <div class="p-4 md:p-8 max-w-5xl w-full mx-auto space-y-6">
            ...
            <div id="tab-dashboard" class="tab-content space-y-6">
                ...
                <!-- Recent Orders (Unpacks 8 values) -->
            ...
            <!-- TAB: CUSTOMER ORDERS (Unpacks 8 values) -->
            ...
            <!-- TAB: SUBSCRIPTION PLANS (Unpacks 5 values) -->
