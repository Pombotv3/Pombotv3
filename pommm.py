...
# ==========================================
# PAYMENT SCREENSHOT HANDLER (MUST COME BEFORE FILE_ID GRABBER)
# ==========================================
...
async def receive_screenshot_proof(message: types.Message, state: FSMContext):
    ...
    # 1. Exact required message to user
    await manager.send_raw("sendMessage", {
        "chat_id": message.chat.id,
    ...
    # 2. Dispatch Accept/Reject verification message directly to admin bot
