...
# Telegram reply keyboard (bottom large buttons) supports style attribute
...
# Telegram inline keyboards ONLY support text and callback_data
THREE_OPTIONS_KEYBOARD = {
    "inline_keyboard": [
        [{"text": "💎 GET PREMIUM", "callback_data": "menu_get_premium"}],
        [{"text": "🥵 DEMO", "callback_data": "menu_demo"}],
        [{"text": "✅ HOW TO GET PREMIUM", "callback_data": "menu_how_to"}]
    ]
}
...
async def handle_start(message: types.Message, state: FSMContext):
    ...
    # 2. Second Message: Choose option with 3 buttons
    await manager.send_raw("sendMessage", {
