    ...
    async with DB_WRITE_LOCK:
        ...
        try:
            ...
            defaults = {
                ...
                "first_caption": "🔥 Premium Video Pack - Sirf ₹69\n\n✅ One Time Payment \n\n✅ Lifetime Access\n\n✅ Instant Delivery\n\n💎 What You Get:\n• Full HD Quality Videos  \n• Regular New Updates  \n• 24x7 Support  \n\nPrice: ₹69 Only 💰 ",
            ...
            default_plans = [
                ...
                ("plan_5", "💎 𝗙𝗢𝗥𝗖𝗘𝗗 𝗥𝗔𝗣𝗘 𝟰𝗞 💀🥵", 59.0, "30 Days", ""),
                ("plan_6", "💎 𝗠𝗢𝗧𝗛𝗘𝗥 𝗔𝗡𝗗 𝗦𝗢𝗡 𝟭𝟬𝟴𝟬𝗣 😜✨", 49.0, "30 Days", ""),
                ("plan_7", "💎 𝗣𝗔𝗥𝗠𝗔𝗡𝗘𝗡𝗧 𝗩𝗜𝗣 𝗣𝗟𝗔𝗡 🥵♾️", 159.0, "Lifetime", ""),
            ]
...
# ==========================================
# KEYBOARDS & STYLED BUTTONS (RESTORED COLOURS)
# ==========================================
...
# 3 Main Menu Buttons with explicit colour styles
...
async def build_dynamic_plans_keyboard():
    ...
    rows = []
    # Alternating colors: Green, Red, Blue, Green, Red, Blue, Green
...
# ==========================================
# CORE BOT COMMANDS (WITH STATEFILTER TO PREVENT LOCKUPS)
# ==========================================
@bot_router.message(CommandStart(), StateFilter("*"))
async def handle_start(message: types.Message, state: FSMContext):
    await state.clear()  # Unlocks the user from any stuck screenshot upload states
    ...
    # 2. Second Message: Choose option with 3 styled buttons
    await manager.send_raw("sendMessage", {
    ...
    # 3. Third Message: Hand pointing emoji via raw runner
    await manager.send_raw("sendMessage", {
        "chat_id": message.chat.id,
        "text": "👇"
    })

# Handles clicking the inline green button
...
async def on_get_premium_click(callback: types.CallbackQuery, state: FSMContext):
    await state.clear()
    await callback.answer()  # Removes the loading spinner immediately
    await send_plan_presentation(callback.message.chat.id)

# Handles tapping the bottom persistent keyboard button
    ...
    <main class="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        ...
        <div class="p-4 md:p-8 max-w-5xl w-full mx-auto space-y-6">
            ...
            <form method="POST" action="/admin/save">
                ...
                <!-- TAB: MEDIA & GREETINGS (DIRECT LINK PASTE, NO JSON REQUIRED) -->
