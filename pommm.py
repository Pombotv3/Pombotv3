...
async def build_dynamic_plans_keyboard():
    """Builds the original styled colored inline buttons (Green, Red, Blue alternating)."""
...
async def send_plan_presentation(chat_id: int):
    ...
    # Direct fallback to text message if photo URL is invalid
    if not res or not res.get("ok"):
        await manager.send_raw("sendMessage", {
            "chat_id": chat_id,
            "text": plan_caption,
...
<body class="text-slate-100 min-h-screen flex">
    ...
    <main class="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        ...
        <div class="p-4 md:p-8 max-w-5xl w-full mx-auto space-y-6">
            ...
            <!-- TAB: SUBSCRIPTION PLANS (Selects 5 values correctly, eliminating unpacking errors) -->
