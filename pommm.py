    ...
    async with DB_WRITE_LOCK:
        ...
        try:
            ...
            defaults = {
                ...
                "plan_media": "https://kommodo.ai/i/4flFaO83RWRaUwWLGaxY",
            ...
            default_plans = [
                ("plan_1", "💎 𝗖𝗢𝗟𝗟𝗘𝗚𝗘 𝗟𝗘𝗔𝗞𝗦 𝟰𝗞 🔞💦", 79.0, "30 Days", "", "success"),
                ("plan_2", "💎 𝗖𝗛𝗜𝗟𝗗 𝗣𝗢𝗥𝗡 𝟮𝗞 👶🥵", 99.0, "30 Days", "", "danger"),
                ("plan_3", "💎 𝗔𝗟𝗟 𝗜𝗡 𝗢𝗡𝗘 𝗣𝗔𝗖𝗞 𝟰𝗞 🔥😋", 129.0, "30 Days", "", "primary"),
                ("plan_4", "💎 𝗩𝗜𝗥𝗔𝗟 𝗠𝗠𝗦 𝗟𝗘𝗔𝗞𝗦 𝟰𝗞 🤩💋", 69.0, "30 Days", "", "success"),
                ("plan_5", "💎 𝗙𝗢𝗥𝗖𝗘𝗗 𝗥𝗔𝗣𝗘 𝟰𝗞 🎬🌽", 59.0, "30 Days", "", "danger"),
                ("plan_6", "💎 𝗠𝗢𝗧𝗛𝗘𝗥 𝗔𝗡𝗗 𝗦𝗢𝗡 𝟭𝟬𝟴𝟬𝗣 😜✨", 49.0, "30 Days", "", "primary"),
            ]
...
# ==========================================
# PARSER HELPER FOR DIRECT LINK INPUT
# ==========================================
def parse_direct_links(text_block: str, default_type: str = "photo") -> list[dict]:
    """
    Accepts direct line-by-line links or Telegram file IDs.
    No JSON formatting required from user.
    """
...
async def send_plan_presentation(chat_id: int):
    # Hardcoded Intermediate Banner Message
    await manager.bot.send_message(chat_id, " ══════« CHOOSE PLAN »═════")[span_4](start_span)[span_4](end_span)[span_5](start_span)[span_5](end_span)
...
async def admin_get_file_id(message: types.Message, state: FSMContext):
    ...
    reply_text = (
        ...
        f"<code>{file_id}</code>\n\n"
        f"<i>💡 Direct paste enabled! Simply paste this file ID directly on a new line in your Admin Panel.</i>"
    )
...
async def handle_start(message: types.Message):
    ...
    # 1. First Message: Images/Videos with caption + bottom persistent keyboard attached directly[span_6](start_span)[span_6](end_span)
    await send_first_media_with_bottom_bar(message.chat.id, media_list, first_caption)

    # 2. Second Message: Choose option with 3 colored buttons[span_7](start_span)[span_7](end_span)
    await manager.send_raw("sendMessage", {
    ...
    # 3. Third Message: Hand pointing emoji[span_8](start_span)[span_8](end_span)
...
# ==========================================
# TEMPLATES (NAGATO CYBERPUNK PANEL WITH DIRECT LINK INPUT & ICONS)
# ==========================================
